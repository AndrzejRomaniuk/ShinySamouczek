  ...
  ui <- fluidPage(
    sidebarLayout(
      ...
      selectInput(                   #Widżet, do którego nawiązuje                    
          ...
          selected = 1)              
      ,  
      conditionalPanel(              #Panel warunkowy
          condition = (              #Ustalenie warunku dla którego
...
| 
Wszystkie elementy niezbędne dla samouczka po Polsku, jak i dla przykładowej aplikacji, w tym wygenerowania pliku PDF, są dostępne na stronie GitHub:  
[github.com/AndrzejRomaniuk/ShinySamouczek](https://github.com/AndrzejRomaniuk/ShinySamouczek)
